...
public class StudentController {
    ...
    @GetMapping("Student/students/{isEnable}/{order_by}/{order}/{page}/{pageSize}")
    public List<Student> getStudents(@PathVariable("isEnable") String isEnable, @PathVariable("order_by") String order_by, @PathVariable("order") String order, @PathVariable("page") int page, @PathVariable("pageSize") int pageSize) {
        return studentService.getStudents(isEnable, order_by, order, page, pageSize);
    }

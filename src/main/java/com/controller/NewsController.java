...
public class NewsController {
    ...
    @GetMapping("News/news/{isEnable}/{order_by}/{order}")
    public List<News> getNews(@PathVariable("isEnable") String isEnable, @PathVariable("order_by") String order_by, @PathVariable("order") String order) {
        return newsService.getNews(isEnable, order_by, order);
    }
